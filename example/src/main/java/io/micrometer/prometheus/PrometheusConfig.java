...
public interface PrometheusConfig extends MeterRegistryConfig {
     ...
     */
    io.micrometer.prometheus.PrometheusConfig DEFAULT = k -> null;

    @Override
    default String prefix() {
        return "io.micrometer.prometheus";
    }
    ...
    default Validated<?> validate() {
        return checkAll(this,
                checkRequired("step", io.micrometer.prometheus.PrometheusConfig::step),
                checkRequired("histogramFlavor", io.micrometer.prometheus.PrometheusConfig::histogramFlavor)
        );
    }
}
